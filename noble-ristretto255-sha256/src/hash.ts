// (c) 2021 Privacy Research, LLC https://privacyresearch.io,  GPL-3.0-only: see LICENSE file.

import {
    Nh,
    OPRFCiphersuite,
    expand_message_xmd as shared_expand_xmd,
    HashFunction,
...
export function expand_message_xmd(msg: Uint8Array, DST: Uint8Array, lenInBytes: number): Uint8Array {
    return shared_expand_xmd(msg, DST, lenInBytes, sha512Hash)
}
